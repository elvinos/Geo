                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Geolocation Analysis</h6>
                                    <p class="description mt-3">Rapidly convert a list of addresses into coordinates for use in maps and distance matricies</p>
                                    <div>
                                        <badge type="primary" rounded>Addresses</badge>
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Scrape Location Data</h6>
                                    <p class="description mt-3">Run basic competitor queries and scrape google maps to generate a list of viable competitors</p>
                                    <div>
                                        <badge type="warning" rounded>competitors</badge>
                                        <badge type="warning" rounded>coming</badge>
                                        <badge type="warning" rounded>soon</badge>
                                    </div>
